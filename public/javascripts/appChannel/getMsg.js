...
var dao =__webpack_require__(30);
var urlConfig =__webpack_require__(8);

module.exports = {
  list:function (url,currentPage, pageSize, params) {
    return dao.page(url, currentPage, pageSize, params)
  },
  get:function (url,data) {
    return dao.get(url,data)
  },
  getRender:function (url,data) {
    return dao.get(apiConfig.proxyApi + url,data)
  },
  allNames:function () {
...
var RTS =function(option,isPageSize){
  var method = option.method ||"get";
  var proxy_url = option.proxy_url;
  var datas = option.datas||{};//参数
